...
import { IContextualMenuItem } from '../../../../node_modules/office-ui-fabric-react/lib/components/ContextualMenu/ContextualMenu.types';
...
export class AppComponent {
  ...
  itemsWithSplitButtonSubmenu: IContextualMenuItem[] = [
    {
      key: 'share',
      split: true,
      onClick: () => { },
